...
public class HexaDeciBlue extends OpMode {
    ...
    public void init()
    {
        ...
        basketPose = new Pose2d(-20,4,0.8); //new Pose2d(-19,5,0.8)

        preHexPose = new Pose2d(30,0.7,0);
        hexPose = new Pose2d(36,0.7,0);

        preOnePose = new Pose2d(-9.5,27,1.5656);
        onePose = new Pose2d(-9.5,32,1.5656);

        preTwoPose = new Pose2d(-21,27,1.5656);
        twoPose = new Pose2d(-21,32,1.5656);

        preThreePose = new Pose2d(-25,40.3,3.16); //20 37.5
        //threePose = new Pose2d(-37,49,3.16); //36
       ...
       // preSurprisePose = new Pose2d(14.4,56.7,3.16);
        ...
        hexaBlock = drive.trajectorySequenceBuilder(preload.end())
                ...
                .forward(7)
                .waitSeconds(10)
                //.lineToLinearHeading(hexPose, NewMecanumDrive.getVelocityConstraint(25, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), NewMecanumDrive.getAccelerationConstraint(30))
                ...
                .addTemporalMarker(2.7,() -> {drive.followTrajectorySequenceAsync(hexaDrop, mail);})
                .build();
        //endregion
        ...
        hexaDrop = drive.trajectorySequenceBuilder(hexaBlock.end())
                ...
                .addTemporalMarker(2,() -> {drive.followTrajectorySequenceAsync(hexaPlop, mail);})
                .build();
        //endregion
        ...
        hexaPlop = drive.trajectorySequenceBuilder(hexaDrop.end())
                ...
                .addTemporalMarker(1.7,() -> {drive.followTrajectorySequenceAsync(cycleOne, mail);})
                .build();
        //endregion
        //endregion
        ...
        plopAnnoying = drive.trajectorySequenceBuilder(dropAnnoying.end())
                ...
                .addTemporalMarker(1.7,() -> {drive.followTrajectorySequenceAsync(surpriseBlock, mail);})
                .build();
        //endregion
        //endregion
        ...
        surpriseBlock = drive.trajectorySequenceBuilder(plopAnnoying.end())
               ...
               // .lineToLinearHeading(surprisePose, NewMecanumDrive.getVelocityConstraint(30, DriveConstants.MAX_ANG_VEL, DriveConstants.TRACK_WIDTH), NewMecanumDrive.getAccelerationConstraint(30))
                ...
                .addTemporalMarker(0.7,() -> {
                    bigWristL.setPosition(0.1);
                    bigWristR.setPosition(0.9);
                    smallWrist.setPosition(0.1367);
                    claw.setPosition(0.3);
