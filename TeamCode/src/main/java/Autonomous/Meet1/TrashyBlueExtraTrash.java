...
@Autonomous
public class TrashyBlueExtraTrash extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        TrajectorySequence crocalor = drive.trajectorySequenceBuilder(startPose)
                .forward(5)
                .build();

        TrajectorySequence litten = drive.trajectorySequenceBuilder(startPose)
                .back(15)
                //.back(5)
                //.strafeRight(25)
                //.back(10)
        ...
        drive.followTrajectorySequence(crocalor);
        ...
        jerkTimer.reset();
        wristRServo.setPosition(0.3);
        wristLServo.setPosition(0.9);
        flpTarget = -600;
        ...
        drive.followTrajectorySequence(litten);
        extTarget = 0;
        for (int i = 0; i < 600; i++) {
            extCONTROLLER();
        }
